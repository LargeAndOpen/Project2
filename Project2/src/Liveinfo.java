...
public class Liveinfo {
	...
	// 美食的 Open Date URL
	private String liveurl = "http://data.coa.gov.tw:8080/od/data/api/eir02/?$format=json";
	...
	public String getFirstFromCity(String City)
	{
		...
		try{
			...
			// 美食 URL + Query
			String url = liveurl + "&$filter=address+like+" + City;
			
			//將美食資訊存在food.txt
			String livefile = "live.txt";
			fm.getFilefromUrl(url, livefile);
			
			// 讀出該檔案
			File f = new File(livefile);
